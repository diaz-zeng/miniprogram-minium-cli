...
_MESSAGES = {
    "en-US": {
        ...
        "error.file_stage_path_invalid": "file.stage requires a user data file path like minium://user-data/<file-name>.",
    ...
    "zh-CN": {
        ...
        "error.file_stage_path_invalid": "file.stage 需要形如 minium://user-data/<file-name> 的用户数据文件路径。",
